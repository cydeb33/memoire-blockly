...
Maze.SKIN = {
    ...
    look: "#000",
    winSound: [visuals_directory_path + json.visuals.winSound[0], visuals_directory_path + json.visuals.winSound[1]],
    crashSound: [visuals_directory_path + json.visuals.crashSound[0], task_directory_path + json.visuals.crashSound[1]],
