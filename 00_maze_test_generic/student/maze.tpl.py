...
for i in range(total):
  ...
  try: 
    ...
    if i == 0:
      ...
      print(str(data["map"]["layout"][i])+"###Vous avez résolu la/les première(s) carte(s) cependant avec la carte suivante, Le personnage emprunte un chemin inexistant .###"+str((i/total)*100)) 
    quit()
